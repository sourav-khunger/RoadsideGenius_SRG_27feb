...
public class NotificationDriverAdapter extends RecyclerView.Adapter<NotificationDriverAdapter.RecyclerHolder> {
    Context context;
    List<Notification> notifications;
    ApiService apiService;
    SharedPreferenceMethod sharedPreferenceMethod;

    public NotificationDriverAdapter(Context context, List<Notification> notifications, ApiService apiService) {
    ...
    @NonNull
    @Override
    public NotificationDriverAdapter.RecyclerHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull NotificationDriverAdapter.RecyclerHolder holder, int position) {
        ...
        if (notification.getTitle().equals("Withdrawl Request Approved")) {
            holder.contentTxt.setText(notification.getTitle() + "  of " + notification.getData().getAmount());
        } else {
            holder.contentTxt.setText(notification.getTitle() + "  for " + notification.getData().getCustomerName());

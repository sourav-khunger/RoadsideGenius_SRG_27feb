...
public class CompletedDriverJobsFragment extends Fragment {
    ...
    public CompletedDriverJobsFragment() {
...
// clone the inflater using the ContextThemeWrapper
        ...
        View view = localInflater.inflate(R.layout.fragment_unassigned, container, false);
...
//        Toast.makeText(getActivity(), sharedPreferenceMethod.getTokenJWT(), Toast.LENGTH_SHORT).show();

        apiService.completedJobsList(sharedPreferenceMethod.getTokenJWT(), "", "", "", "")
                .enqueue(new Callback<CompletedJobListModel>() {
                    ...
                    public void onResponse(Call<CompletedJobListModel> call, Response<CompletedJobListModel> response) {
                        ...
                        if (response.body().getResponse().getStatus().equals("Success")) {
                            ...
                            Log.d("completed jobs", response.body().getResponse().getJobs()+"");
                            if (jobs.size() == 0) {
